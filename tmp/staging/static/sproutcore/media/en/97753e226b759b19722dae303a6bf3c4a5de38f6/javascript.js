/* >>>>>>>>>> BEGIN source/views/mediaSlider.js */
// ==========================================================================
...
/* >>>>>>>>>> BEGIN source/views/miniControls.js */
// ==========================================================================
// Project:   SproutCore - JavaScript Application Framework
// Copyright: ©2006-2009 Sprout Systems, Inc. and contributors.
//            Portions ©2008-2009 Apple Inc. All rights reserved.
    ...
    if(firstTime){
      for(i=0, listLen = this.degradeList.length; i<listLen; i++){
        ...
        case "quicktime":
          ...
          return;
        case "flash":
          var flashURL= '/static/sproutcore/media/en/97753e226b759b19722dae303a6bf3c4a5de38f6/resources/videoCanvas.swf';
